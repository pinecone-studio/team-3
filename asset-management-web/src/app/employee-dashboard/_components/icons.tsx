export function DeviceIcon({ type, size = 20 }: { type: string; size?: number }) {
  if (type === 'monitor') {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <rect x="2" y="3" width="20" height="13" rx="1.5" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M8 21h8M12 16v5" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  if (type === 'phone') {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <rect x="5" y="2" width="14" height="20" rx="2" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M12 18h.01" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  if (type === 'keyboard') {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <rect x="2" y="6" width="20" height="12" rx="2" stroke="#6B7280" strokeWidth="1.5" />
        <path d="M6 10h.01M10 10h.01M14 10h.01M18 10h.01M6 14h12" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    );
  }
  // laptop default
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M4 5a1 1 0 011-1h14a1 1 0 011 1v10H4V5z" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M2 15h20l-1.5 3H3.5L2 15z" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
  ...
  if (type === 'qr') {
    return (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M14 14h3v3M17 17v4M14 17h3M14 21h7" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
...
export function WarningTriangle({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className="flex-shrink-0">
      ...
      <path d="M12 9v4M12 17h.01" stroke="#EF4444" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
