...
export type GetAssetsForAssetPageQuery = { __typename?: 'Query', getAssets: Array<{ __typename?: 'Asset', assetTag: string, id: string, status: AssetStatusEnum, category?: { __typename?: 'Category', id: string, name: string } | null }> };
