...
export type CensusEventResolvers<
	ContextType = Context,
	ParentType extends ResolversParentTypes['CensusEvent'] = ResolversParentTypes['CensusEvent'],
> = {
...
export type CensusReportResolvers<
	ContextType = Context,
	ParentType extends ResolversParentTypes['CensusReport'] = ResolversParentTypes['CensusReport'],
> = {
...
export type CensusTaskResolvers<
	ContextType = Context,
	ParentType extends ResolversParentTypes['CensusTask'] = ResolversParentTypes['CensusTask'],
> = {
	assetId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
> = {
	...
	deleteCategoryByIds?: Resolver<
		ResolversTypes['Response'],
		ParentType,
		ContextType,
		RequireFields<MutationDeleteCategoryByIdsArgs, 'ids'>
	>;
	deleteEmployee?: Resolver<ResolversTypes['Response'], ParentType, ContextType, RequireFields<MutationDeleteEmployeeArgs, 'id' | 'input'>>;
	finalizeCensusEvent?: Resolver<
		ResolversTypes['Response'],
		ParentType,
		ContextType,
		RequireFields<MutationFinalizeCensusEventArgs, 'censusId'>
	>;
	...
	updateAssignment?: Resolver<
		ResolversTypes['Response'],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateAssignmentArgs, 'id' | 'input'>
	>;
...
export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
	...
	getAssignmentById?: Resolver<
		Maybe<ResolversTypes['Assignment']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetAssignmentByIdArgs, 'id'>
	>;
	getAssignments?: Resolver<Array<ResolversTypes['Assignment']>, ParentType, ContextType>;
	getAssignmentsByAsset?: Resolver<
		Array<ResolversTypes['Assignment']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetAssignmentsByAssetArgs, 'assetId'>
	>;
	getAssignmentsByEmployee?: Resolver<
		Array<ResolversTypes['Assignment']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetAssignmentsByEmployeeArgs, 'employeeId'>
	>;
	...
	getCensusEventById?: Resolver<
		Maybe<ResolversTypes['CensusEvent']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetCensusEventByIdArgs, 'id'>
	>;
	...
	getCensusTaskByAssetId?: Resolver<
		Maybe<ResolversTypes['CensusTask']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetCensusTaskByAssetIdArgs, 'assetId' | 'censusId'>
	>;
	getCensusTaskById?: Resolver<
		Maybe<ResolversTypes['CensusTask']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetCensusTaskByIdArgs, 'id'>
	>;
	getCensusTasks?: Resolver<Array<ResolversTypes['CensusTask']>, ParentType, ContextType>;
	getEmployeeByCode?: Resolver<
		Maybe<ResolversTypes['Employee']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetEmployeeByCodeArgs, 'employeeCode'>
	>;
	...
	getEmployeesByStatus?: Resolver<
		Array<ResolversTypes['Employee']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetEmployeesByStatusArgs, 'status'>
	>;
	getPendingAssignments?: Resolver<
		Array<ResolversTypes['Assignment']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetPendingAssignmentsArgs, 'token'>
	>;
	testQuery?: Resolver<Array<ResolversTypes['Data']>, ParentType, ContextType>;
};

export type TestQueryResponseResolvers<
	ContextType = Context,
	ParentType extends ResolversParentTypes['TestQueryResponse'] = ResolversParentTypes['TestQueryResponse'],
> = {
